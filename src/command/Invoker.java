    ...
    public Receiver executeCommand(String rawCommand){
        ...
        if(rawCommand.matches("help")){
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды info");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды show");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды add");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды clear");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды exit");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды history");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды max_by_group_admin");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды print_field_descending_group_admin");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды update");
            } finally {
            ...
            try{
                ...
                System.err.println("Возникла ошибка при выполнении команды remove_by_id");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды execute_script");
            } finally {
            ...
            try {
                ...
                System.err.println("Возникла ошибка при выполнении команды filter_less_than_semester_enum");
            } finally {
